    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
              ...
              <th scope="col" class="px-6 py-3 text-left"> Player Name </th>
              <th scope="col" class="px-6 py-3 text-left"> Team Name </th>
              <th scope="col" class="px-6 py-3 text-left"> Coach Name </th>
              <th scope="col" class="px-6 py-3 text-left"> Donor Email </th>
              <th scope="col" class="px-6 py-3 text-left"> Donor Donations </th>
          </tr>
      </thead>
      <tbody>
        ...
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="px-6 py-4 whitespace-nowrap">{{ $donation_detail->email }}</td>
            <td class="px-6 py-4 whitespace-nowrap">${{ $donation_detail->amount }}</td>
        </tr>
        @endforeach
        @else
          <tr>
