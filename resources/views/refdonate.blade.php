...
<head>
    <meta charset="utf-8">
    <title>YourTeamBoost - Donate</title>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-6 mb-5">Thank you for supporting {{$data->name}}!</h1>
                    <p class="mb-0"></p>
                </div>
                  ...
                            @endif
                      <form action="/session" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" name="name" class="form-control bg-light border-0" id="name" placeholder="Your Name" value="{{$data->name}}" readonly>
                                    <label for="name">Referrer Name</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="email" name="refemail" class="form-control bg-light border-0" id="email" placeholder="Referal Email" value="{{$data->email}}" readonly>
                                    <label for="email">Referrer Email</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" name="name" class="form-control bg-light border-0" id="name" placeholder="Your Name" value="{{$data->team_name}}" readonly>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="number" name="amount" class="form-control bg-light border-0" id="amount" placeholder="Enter Amount">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" name="message" class="form-control bg-light border-0" id="message" placeholder="Enter Message">
