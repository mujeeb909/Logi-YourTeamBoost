...
@section('contents')
	...
	<div class="space-y-4 text-center divide-y dark:divide-gray-300">
		<div class="my-2 space-y-1">
			...
			<p class="px-5 text-xs sm:text-base dark:text-gray-600">{{($user->type==0)?"Coach":"Playeer"}}</p>
		</div>
		<div class="flex justify-center pt-2 space-x-4 align-center">
			...
			<a rel="noopener noreferrer" href="#" aria-label="Dribble" class="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
            <dl class="sm:divide-y sm:divide-gray-200">
                ...
                <div class="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        {{ $user->type == 0 ? 'Coach' : 'Player' }} <!-- Fixed typo in "Player" -->
                    </dd>
                </div>
                <div class="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt class="text-sm font-medium text-gray-500">
