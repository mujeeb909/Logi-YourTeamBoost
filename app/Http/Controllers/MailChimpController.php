...
//             "email_address" => "ham123456@hotmail.com",
//             "status" => "subscribed",
//             "merge_fields" => [
//                 "FNAME" => "Hamzaaa",
//                 "LNAME" => "Khalidaa"
//             ],
//             "tags" => ["specific_tag"] // Specify the specific tag here
//         ]);
...
{   
    ...
    public function getListMember()
    {
        try {
            ...
            // Replace 'prudence.mcvankab@example.com' with the email you want to check
            $email = "mohammad.mujeeb051@hotmail.com";
    ...
    public function updateListMemberStatus()
    {
        try {
            // Include the autoload file if it's not already autoloaded
            if (!class_exists(\MailchimpMarketing\ApiClient::class)) {
            ...
            // Replace 'prudence.mcvankab@example.com' with the email you want to update
            $email = "moh.mujeeb123@hotmail.com";
            $subscriberHash = md5(strtolower($email));

            // Update the list member status to 'unsubscribed'
