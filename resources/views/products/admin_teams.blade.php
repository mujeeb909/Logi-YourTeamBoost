        ...
        @foreach($coachData as $coach)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4 whitespace-normal">
                  <a class="flex rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 view-emails addAudienceCampaignBtn" href="#" data-coach-id="{{ $coach['id'] }}" style="width:87%">Add Audience + Campaigns</a>
              </td>
            </tr>
        @endforeach
    @else
...
<script>
  ...
  document.getElementById('confirmBtn').addEventListener('click', function() {
      ...
      .then(data => {
          ...
          if (confirm("Audiences are added in contact successfully. Do you want to proceed with the campaign?")) {
