        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-6 mb-5">Thank you for supporting <br /> {{ $data->name }}!</h1>
                    <p class="mb-0"></p>
                </div>
                    ...
                    <div class="h-100 bg-secondary p-5">
                        ...
                        <form action="/session" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="email" name="refemail" class="form-control bg-light border-0"
                                            id="email" placeholder="Referal Email" value="{{ $data->email }}"
                                            readonly>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" name="message" class="form-control bg-light border-0"
