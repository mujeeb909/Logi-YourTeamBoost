                ...
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row justify-content-center align-items-center"> <!-- Center align and vertically center the content -->
                            <div class="col-lg-7 text-center text-lg-start custom-test"> <!-- Center align text and start alignment on lg screens -->
                                <h1 class="display-4 text-white mb-3 animated slideInDown">Raise more, stress less.</h1>
                                <p class="fs-5 text-white-50 mb-5 animated slideInDown">Experience the power of effortless fundraising, where you can raise more and stress less. Our innovative approach takes the hassle out of raising funds, allowing you to achieve greater results with ease.</p>
                                <a class="btn btn-primary py-2 px-3 animated slideInDown" href="{{ route('coach-register') }}">
                                    Register Now
                                    <div class="d-inline-flex btn-sm-square bg-white text-primary rounded-circle ms-2">
                                        <i class="fa fa-arrow-right"></i>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative overflow-hidden h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100 pt-5 pe-5" src="img/ytb_image_1.jpeg" alt="" style="object-fit: cover;">
                    </div>
                </div>
...
donation platform to accept direct financial contributions.
                            ...
                            <span class="text-primary"> <div class="testimonial-item">
                    <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="img/christine_pic.jpg" style="width: 100px; height: 100px;">
                   Christine Richardson, Founder
                    </div></span>
                        </div>
<!--                        <p class="mb-5">At Your Team Boost, we specialize in providing an easy-->
<!--solution to a diverse range of organizations, including team sports,-->
